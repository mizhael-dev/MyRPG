...
*Derived Stats: Stamina (`MaxAP`), Focus (`MaxFP`) are renewable resources on rest. Maximal capacity is derived from Core Attributes.*

*Resources: AP, FP are renewable resources between combat encounters. Track amounts for precise combat management.

#### Core Attributes:

- **Constitution:** 10 (Stamina)
- **Willpower:** 10 (Focus)
- 
...
#### Derived Attributes:
 ...
 - **Max Stamina (`MaxAP`):** Equal to: Constitution x 2
 - **Max Focus: (`MaxFP`)** Equal to: Willpower / 5
