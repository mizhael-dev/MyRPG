...
**Result:** A deflection with 300ms counter bonus reduces next attack windUp from 500ms → 200ms, giving a massive riposte advantage, while keeping the original `skill.phases.windUp.duration = 500` immutable.
...
### 12. **Skill Renaming: slash → side_slash**
